#ifndef VSPluginMarkerLocalization2DUKFNodeH
#define VSPluginMarkerLocalization2DUKFNodeH

// base classes
#include "../VSLibSensorDataProcessing/VSLibSensorDataProcessingSensorDataProcessingNodeBase.h"

// other
#include "../VSLibMarkerLocalization/VSLibMarkerLocalization2DUKF.h"
...
{
   class Marker2DUKFNode : public VSLibSensorDataProcessing::SensorDataProcessingNodeBase
   {
      VSD_ENVIRONMENT_INSTANCE(
         DISPLAY_NAME tr("Marker2DUKFNode")
      );

   // construction
   protected:
	   Marker2DUKFNode(VSD::SimState* mySimState, VSD::SimStateInstance* otherSimStateInstance);
      virtual ~Marker2DUKFNode();
   ...
   private:
      ...
      // visu
		...
		// UKF vars
		//VSM::Matrix3x3 Q_, R_;
		VSLibMarkerLocalization::UKF2DInstance filter_;
...
VSD_DECLARE_ENVIRONMENT_INSTANCE(VSPluginMarkerLocalization::Marker2DUKFNode);
